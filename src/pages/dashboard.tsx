...
// import { Moon, Sun, LogOut, Sparkles, Github, Twitter, Heart, ImageIcon } from 'lucide-react';
import { Moon, Sun, ImageIcon, LogOut, Sparkles, Github, Twitter, Heart, X, Download, Save, Share2, Copy, Check, Settings, User, Menu } from 'lucide-react';
 ...
 return (
    ...
    <nav className={`border-b transition-colors duration-300 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-5">
            <button
              ...
              className="cursor-pointer p-2 rounded-md transition-colors hover:bg-slate-800 hover:text-slate-100"
            >Community</button>
            <button
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-md transition-colors hover:bg-slate-800 hover:text-white"
            >
        ...
        {menuOpen && (
          <div className="md:hidden mt-4 space-y-2">
            <button
              ...
              className="block w-full text-left p-2 rounded-md transition-colors hover:bg-slate-800 hover:text-slate-100"
            >Community</button>
            <button
          ...
          <div className="max-w-2xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                />
                {/* <ImageIcon className={`absolute right-3 top-3 h-5 w-5 ${
          ...
          {images.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {images.map((img, index) => (
                <div
                  key={index}
                  className={`group rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 cursor-pointer ${
                    darkMode 
      ...
      {isModalOpen && selectedImage && (
        ...
        >
          <div 
            className={`relative max-w-7xl max-h-[95vh] w-full rounded-xl overflow-y-auto ${
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row max-h-[calc(95vh-80px)]">
              ...
              <div className={`lg:w-80 p-6 border-l ${
                darkMode ? 'border-slate-700' : 'border-slate-200'
              }`}>
                <div className="mb-6">
      ...
      <footer className={`border-t transition-colors duration-300 ${
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className={`mt-8 pt-6 border-t flex flex-col sm:flex-row items-center justify-between ${
            ...
            <div className={`flex items-center space-x-1 text-sm mt-2 sm:mt-0 ${
              darkMode ? 'text-slate-400' : 'text-slate-600'
            }`}>
              <span>Made with</span>
